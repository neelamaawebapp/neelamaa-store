      ...
      <div className="pt-3 pb-2 px-4">
        ...
        <div className="flex justify-between items-center mb-3">
          ...
          <div className="flex items-center space-x-2 text-xs">
            <div className="flex items-center space-x-0.5 text-gray-655 font-semibold max-w-[120px] overflow-hidden whitespace-nowrap">
        ...
        <div className="flex items-center space-x-3">
          {/* Search Bar */}
          <div className="flex-1 bg-gray-50 rounded-full flex items-center px-3.5 py-2 border border-gray-100/80 shadow-inner">
